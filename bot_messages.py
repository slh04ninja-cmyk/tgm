...
Organisation :
  ...
  2. Logs et alertes de BE (Break-Even) — 1 position, SL @ entry + TP @ entry ± TP_FIXED
  ...
  8. Fusion (SL/TP mis à jour)
  9. 1 signal par canal
=============================================================
"""


# =============================================================
# 1. CLÔTURE DE POSITION (TP / SL / CLOSE / TP-FIXED auto)
# =============================================================
...
def alert_close(label: str, action: str, symbol: str, pnl: float, idx: int, total: int,
    ...
    """Alerte Telegram à la clôture d'un ticket (TP, SL, CLOSE, TP-FIXED auto)."""
    if label == "TP":
        emoji = "🎯"
    elif label == "SL":
        emoji = "🛑"
...
# =============================================================
# 2. BREAK-EVEN (BE) — 1 position, SL @ entry + TP @ entry ± TP_FIXED_GAIN_USD
# =============================================================
...
def alert_be_activated(action: str, symbol: str, nb_pos: int, sl_price: float, target_gain: float,
    ...
    SL @ entry + TP @ entry ± TP_FIXED_GAIN_USD. MT5 ferme automatiquement."""
    return (
...
def log_order_placed_dual(mt5_comment: str, type1: str, ticket1: int, price1,
    ...
    """Variante pour les signaux à deux ordres (non utilisé en v11 SINGLE_POSITION_MODE)."""
...
def log_tp_trigger(mt5_comment: str, prices_str: str, pending_count: int) -> str:
    """TP_TRIGGER — non utilisé en v11 (pas de pending orders)."""
...
def log_merge_limit_placed(ch_num, action: str, symbol: str, ticket: int, price, sl) -> str:
    """Non utilisé en v11 (pas de merge LIMIT)."""
...
# =============================================================
# 9. TP-FIXED (gain fixe — fermeture manuelle par le bot)
#    En v11, MT5 ferme via le TP. Ces fonctions restent pour
#    les cas de fallback (fermeture manuelle si BE pas activé).
# =============================================================
